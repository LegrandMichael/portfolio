	...
	<div class="tab-pane col-md-12 " id="general-settings"><!-- plugin General selection setting -->
		<div class="col-md-12 option">
			...
			<ul class="nav nav-tabs">
				...
				<li><a data-toggle="tab" href="#layout"><?php _e('Layout Manager','RCSM_TEXT_DOMAIN'); ?></a></li>
			</ul>
			<div class="tab-content">
				...
				<div id="appearance" class="tab-pane fade in active"> <!-- Appearance selection setting -->
					<form method="post" id="weblizar_rcsm_appearance_option">
						...
						<div class="restore">							
							<input type="hidden" id="security" name="security" value="<?php echo $comsoon_security_action_nonce; ?>" />
				...
				<div id="general-option" class="tab-pane fade in">
					<form method="post" id="weblizar_rcsm_general_option">
						<h1><?php _e('SEO Selection Settings','RCSM_TEXT_DOMAIN'); ?></h1>
						<div class="col-md-12 form-group">
							<div class="row">
						...
						<div class="col-md-12 form-group">
							...
							<div class="col-md-6 no-pad">
								<div class="row">
									<input class="form-control" type="text" value="<?php if($wl_rcsm_options['upload_favicon']!='') { echo esc_attr($wl_rcsm_options['upload_favicon']); } ?>" id="upload_favicon" name="upload_favicon" size="36" class="upload has-file"/>
						...
						<div class="restore">
							...
							<input class="button left" type="button" name="reset" value="<?php _e('Restore Defaults','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_reset('general_option', '<?php echo $comsoon_security_action_nonce; ?>');">
							<input class="button button-primary left" type="button" value="<?php _e('Save Options','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_save('general_option', '<?php echo $comsoon_security_action_nonce; ?>')" >
						</div>
					</form>
				</div>
				...
				<div id="access-control" class="tab-pane fade in">
					<form action="post" id="weblizar_rcsm_access_control_option" >
						...
						<div class="restore">
							...
							<input class="button left" type="button" name="reset" value="<?php _e('Restore Defaults','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_reset('access_control_option', '<?php echo $comsoon_security_action_nonce; ?>');">
							<input class="button button-primary left" type="button" value="<?php _e('Save Options','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_save('access_control_option', '<?php echo $comsoon_security_action_nonce; ?>')" >
						</div>
					</form>
				</div>
					...
					<form method="post" id="weblizar_rcsm_layout_option">
						...
						<div class="col-md-12 form-group">
							...
							<div class="restore">
								...
								<input class="button left" type="button" name="reset" value="<?php _e('Restore Defaults','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_reset('layout_option', '<?php echo $comsoon_security_action_nonce; ?>');">
								<input class="button button-primary left" type="button" value="<?php _e('Save Options','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_save('layout_option', '<?php echo $comsoon_security_action_nonce; ?>')" >
							</div>
					</form>
				</div>
			</div>
				...
				<div id="page-social" class="tab-pane fade in active"> <!-- Social link and icon setting -->
					<form action="post" id="weblizar_rcsm_social_option">
						...
						<div class="restore">
							...
							<input class="button left" type="button" name="reset" value="<?php _e('Restore Defaults','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_reset('social_option', '<?php echo $comsoon_security_action_nonce; ?>');">
							<input class="button button-primary left" type="button" value="<?php _e('Save Options','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_save('social_option', '<?php echo $comsoon_security_action_nonce; ?>');" >
						</div>
					</form>
				</div>
			</div>
				...
				<div id="subscriber-settings" class="tab-pane fade in active">
					<form action="post" id="weblizar_rcsm_subscriber_option">
						...
						<div class="restore">
							...
							<input class="button left" type="button" name="reset" value="<?php _e('Restore Defaults','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_reset('subscriber_option', '<?php echo $comsoon_security_action_nonce; ?>');">
							<input class="button button-primary left" type="button" value="<?php _e('Save Options','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_save('subscriber_option', '<?php echo $comsoon_security_action_nonce; ?>')" >
						</div>
					</form>
				</div>
				...
				<div id="subscriber-provider-option" class="tab-pane fade in ">
					<form action="post" id="weblizar_rcsm_subscriber_provider_option">
							...
							<div class="col-md-12 form-group">
								...
								<div class="col-md-6">
									...
									<ul class="instruction_points theme_msg_heading">
										<li><?php _e('WordPress Guideline: PHP Mailer Library Removed due to not supported by WordPress.org 4.7.2.', RCSM_TEXT_DOMAIN ); ?></li>
						...
						<div class="restore">
							...
							<input class="button left" type="button" name="reset" value="<?php _e('Restore Defaults','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_reset('subscriber_provider_option', '<?php echo $comsoon_security_action_nonce; ?>');">
							<input class="button button-primary left" type="button" value="<?php _e('Save Options','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_save('subscriber_provider_option', '<?php echo $comsoon_security_action_nonce; ?>')" >
						</div>
					</form>
				</div>
				...
				<div id="subscriber-list" class="tab-pane fade in">					
					<form action="post" id="weblizar_rcsm_subscribe_form">						
							...
							<div class="subscribers-settings-wrap settings-content" >
								...
								<div class="row o_buttons">
									<div class="col-md-8 form-group">
										...
										-->
										<a class="button" href="#" onclick="return download_list('subscribers', '<?php echo $comsoon_security_action_nonce; ?>', '<?php echo date("d-m-Y-H-i-s"); ?>');">All Subscribers</a>
										<a class="button" href="#" onclick="return download_list('active', '<?php echo $comsoon_security_action_nonce; ?>', '<?php echo date("d-m-Y-H-i-s"); ?>');">Active Subscribers</a>
										<a class="button" href="#" onclick="return download_list('pending', '<?php echo $comsoon_security_action_nonce; ?>', '<?php echo date("d-m-Y-H-i-s"); ?>');">Pending Subscribers</a>
										<?php
										...
										function download_list(list_type, security, file_date_time){
											...
											var full_file_name_url = "<?php echo $upload_dir_url; ?>/" + full_file_name;
						...
						<div class="restore">
							...
							<input class="button left" type="button" name="reset" value="<?php _e('Restore Defaults','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_reset('subscribe_form', '<?php echo $comsoon_security_action_nonce; ?>');">
							<input class="button button-primary left" type="button" value="<?php _e('Save Options','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_save('subscribe_form', '<?php echo $comsoon_security_action_nonce; ?>')" >
						</div>
					</form>
				</div>
			</div>
				...
				<div id="counter-settings" class="tab-pane fade in active"> <!-- Counter Clock and Progress Bar General Settings -->
					<form action="post" id="weblizar_rcsm_counter_clock_option">
						...
						<div class="restore">
							...
							<input class="button left" type="button" name="reset" value="<?php _e('Restore Defaults','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_reset('counter_clock_option', '<?php echo $comsoon_security_action_nonce; ?>');">
							<input class="button button-primary left" type="button" value="<?php _e('Save Options','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_save('counter_clock_option', '<?php echo $comsoon_security_action_nonce; ?>')" >
						</div>
					</form>
				</div>
			</div>
				...
				<div id="footer-setting" class="tab-pane fade in active"> <!--Footer Section General Setting-->
					<form action="post" id="weblizar_rcsm_footer_option">
						...
						<div class="restore">
							...
							<input class="button left" type="button" name="reset" value="<?php _e('Restore Defaults','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_reset('footer_option', '<?php echo $comsoon_security_action_nonce; ?>');">
							<input class="button button-primary left" type="button" value="<?php _e('Save Options','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_save('footer_option', '<?php echo $comsoon_security_action_nonce; ?>')" >
						</div>
					</form>
				</div>
			</div>
				...
				<div id="advance-settings" class="tab-pane fade in active">	 <!-- Advance options General Setting -->
					<form action="post" id="weblizar_rcsm_advance_settings_option">
						...
						<div class="restore">		  
							...
							<input class="button left" type="button" name="reset" value="<?php _e('Restore Defaults','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_reset('advance_settings_option', '<?php echo $comsoon_security_action_nonce; ?>');">
							<input class="button button-primary left" type="button" value="<?php _e('Save Options','RCSM_TEXT_DOMAIN');?>" onclick="weblizar_rcsm_option_data_save('advance_settings_option', '<?php echo $comsoon_security_action_nonce; ?>')" >
						</div> 
					</form>
				</div>
			</div>

...
Appointment booking and online scheduling plugin by Weblizar is known for faster and better integration into any WordPress website. Online appointments booking makes sure that you are not lacking at appointments booking and events registration, as well as reminders, confirmations and follow-ups.
...
**[Check Live Demo In Action](http://demo.weblizar.com/appointment-scheduler-free-plugin/)**
...
https://www.youtube.com/watch?v=kn0bH18jveo
...
* Try Live Demo - [Click Here](http://demo.weblizar.com/appointment-scheduler-pro/)
...
* Hindi(hi_HI) by Shobhit Saxena [Infigo Software](http://infigosoft.com)
* Greek(el) by A User


== Installation ==

1. Upload the entire **appointment-scheduler-weblizar** folder to the **/wp-content/plugins/** directory.
...
= 1.0.7 =
* Weblizar theme compatibility issue fix
= 1.0.6 =
* version update
= 1.0.5 =
* version update
...
Please use WordPress [support forum](http://wordpress.org/support/plugin/appointment-scheduler-weblizar) to ask any query regarding any issue.